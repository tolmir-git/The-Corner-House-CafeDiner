    ...
    <main className="container mx-auto px-4 sm:px-6 py-12">
        <div className="text-center mb-12">
         ...
         <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 md:gap-8 mb-12">
            ...
            <div className="bg-white rounded-3xl p-6 sm:p-8 card shadow-md col-span-1 md:col-span-3">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-2 gap-4">
                    <div className="flex justify-between items-center border-b sm:border-b-0 sm:border-r sm:pr-4 pb-2 sm:pb-0 border-gray-200">
                        <h3 className="font-semibold text-lg">Homemade Bubble & Squeak</h3>
                        <span className="price text-lg">£2.00</span>
                    </div>
                    <div className="flex justify-between items-center sm:pl-4">
                        <h3 className="font-semibold text-lg">Hash Brown</h3>
                        <span className="price text-lg">80p</span>
                    </div>
                    <div className="flex justify-between items-center border-b sm:border-b-0 sm:border-r sm:pr-4 pb-2 sm:pb-0 border-gray-200">
                        <h3 className="font-semibold text-lg">Chips</h3>
                        <span className="price text-lg">£3.25</span>
                    </div>
                </div>
            </div>
        </div>
